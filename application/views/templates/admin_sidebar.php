<ul class="navbar-nav sidebar accordion sidebar-light" id="accordionSidebar" style="background: #FFF3E9">
	...
	<li class="nav-item">
		...
		<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
			<div class="bg-white py-2 collapse-inner rounded">
				<a class="collapse-item" href="<?= base_url('anggota/dokter') ?>">Pengawas Toko</a>
				<a class="collapse-item" href="<?= base_url('anggota/perawat') ?>">Tukang Kebun</a>
				<a class="collapse-item" href="<?= base_url('anggota/apoteker') ?>">Driver</a>
